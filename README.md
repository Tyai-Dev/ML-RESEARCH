...
| Folder | Concept |
|---|---|
| `bernoulli/` | Bernoulli MLE: closed form, gradient descent, SGD (one sample per step), and SGD via PyTorch autograd — with a proof-by-computation that autograd reproduces the hand gradient exactly |

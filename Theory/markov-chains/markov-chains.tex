...
curse measured in \texttt{text-to-text/ngram-mlp}). Verified numerically on
...
\texttt{text-to-text/bigram.tex}, Gibbs optimality in
...
(\texttt{text-to-text/bigram}'s $65 \times 65$ chain): the leading left

...
curse measured in \texttt{llm/ngram-mlp}). Verified numerically on
...
\texttt{llm/bigram.tex}, Gibbs optimality in
...
(\texttt{llm/bigram}'s $65 \times 65$ chain): the leading left

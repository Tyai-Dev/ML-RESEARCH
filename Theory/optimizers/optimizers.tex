...
a mini-batch (as in \texttt{Theory/distributions/bernoulli/}, \texttt{Theory/distributions/gaussian/},
\texttt{Algorithms/regression/linear/}): cost per step drops from $O(n)$ to $O(1)$
